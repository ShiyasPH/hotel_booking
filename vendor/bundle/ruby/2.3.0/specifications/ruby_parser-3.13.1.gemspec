...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["History.rdoc", "Manifest.txt", "README.rdoc", "debugging.md"]
  s.files = ["History.rdoc", "Manifest.txt", "README.rdoc", "bin/ruby_parse", "bin/ruby_parse_extract_error", "debugging.md"]
