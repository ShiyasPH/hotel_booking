# -*- encoding: utf-8 -*-
# stub: mime-types-data 3.2019.0331 ruby lib

Gem::Specification.new do |s|
  s.name = "mime-types-data"
  s.version = "3.2019.0331"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<mime-types>, ["< 4", ">= 3.2.1"])
      s.add_development_dependency(%q<rdoc>, ["< 6", ">= 4.0"])
      ...
      s.add_dependency(%q<mime-types>, ["< 4", ">= 3.2.1"])
      s.add_dependency(%q<rdoc>, ["< 6", ">= 4.0"])
